...
@Component({
  selector: 'app-mis-ticket-cerrados',
  templateUrl: './mis-ticket-cerrados.component.html',
  styleUrls: ['./mis-ticket-cerrados.component.css']
})
export class MisTicketCerradosComponent implements OnInit{
  ticket : any []= [];
  pagina!:number;
...
this.ticket_mios.id_user = localStorage.getItem('id_user_front');
    this.tickets.ListaMisTicketcerrados(this.ticket_mios).subscribe(
      (dato:any) => {
        this.ticket = dato;
